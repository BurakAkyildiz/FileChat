...
*/
public class CreateEditSharedFile extends javax.swing.JFrame
{
    ...
    CreateEditSharedFile me = null;
    
    /**
     * Creates new form CreateNewSharedFile
     */
    public CreateEditSharedFile(FileServer root, SharedFile oldSharedFile)
    {
    ...
    {//GEN-HEADEREND:event_btn_SelectFileActionPerformed
        ...
        TimerTask listViewYenile = new TimerTask()
        {
            @Override
            public void run()
            {
        ...
        zamanlayici.schedule(listViewYenile, 0, 125);
        ...
        new Thread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                if(selection == JFileChooser.APPROVE_OPTION)
                {
                    ...
                    long size = fillDlm(selectedFiles);
                    fillSelectedFileArr();
                    ...
                    lbl_Size.setText((size/1024)+"."+(size%1024));
                    allSize = size;
                    isFileSelected = true;
                }
                setShareButtonState();
